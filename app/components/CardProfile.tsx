...
export default function CardProfile(props:any) {
  ...
  return (
    <div className="flex-1 max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900 p-4">
      ...
      <div className="p-4 border-t mx-8 mt-2">
          <Link href={`detail/${data.no_urut}`} replace className="w-1/2 block mx-auto rounded-full bg-gray-900 hover:shadow-lg font-semibold text-white px-6 py-2">Detail</Link>
      </div>
    </div>
  );
}
